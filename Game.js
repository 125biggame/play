            ...
            if (input.keys.indexOf(true) !== -1) {
                ...
                if (ball.kick()) {
                    ...
                    if (ball.getX() > fieldgoal.getX() + fieldgoal.getWidth() * 0.1 && ball.getX() < fieldgoal.getX() + fieldgoal.getWidth() - fieldgoal.getWidth() * 0.1) {
                        ...
                        ctx.fillText("You scored +3 for " + team.toUpperCase(), canvas.width / 2, canvas.height * 2 / 5);
                        ctx.fillText("See if your friends can make it ;) ", canvas.width / 2, canvas.height * 3 / 5);
